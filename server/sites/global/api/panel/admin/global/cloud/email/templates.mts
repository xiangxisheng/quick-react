...
import { cloudEmailPurposeKeys, cloudEmailPurposeOptions, cloudEmailTemplateDefaults, validateCloudEmailTemplateVariables } from '@server/modules/global/cloud/email-purposes.mjs';
import { getAliyunDirectMailTemplate, listAliyunDirectMailTemplates } from '@server/modules/global/cloud/providers/aliyun-direct-mail.mjs';
import { getTencentSesTemplate, listTencentSesTemplates } from '@server/modules/global/cloud/providers/tencent-ses.mjs';
import type { CloudEmailScope, CloudEmailTemplate } from '@server/modules/global/cloud/index.mjs';
