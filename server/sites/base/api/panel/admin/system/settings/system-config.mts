...
import { normalizeSystemConfig } from '@server/modules/base/system-config.mjs';
...
const formPage = {
	...
	initialValues: { httpPort: '8088', domain: 'anan.cc', publicOrigin: '', trustedProxyIps: '', mapAllowedIps: '', debug: false },
	fields: [
