...
const handler: ApiHandler = async (c, next, params) => {
	...
	if (c.req.method === 'GET') {
		...
		return apiResponse(c, 200, { table: { ...table, option: { ...table.option, actions: sqliteTableActions, queryFields: sqliteQueryFields(`${site.databaseTarget.kind === 'binding' ? 'D1' : 'SQLite'}（当前）`, tables) } } });
	}
